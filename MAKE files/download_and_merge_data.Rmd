...
```{r}
openingweekend_unique <- read.csv("~/Documents/Investigating-IMDB-data/gen/data-preparation/input_downloading_and_merging/weekend_data.csv")

openingweekend_unique <- read.csv("../../gen/data-preparation/input_downloading_and_merging/weekend_data.csv")
...
# Genereer het volledige pad
folder_path <- file.path(folder, csv_bestand)

# Schrijf het CSV-bestand naar het volledige pad
