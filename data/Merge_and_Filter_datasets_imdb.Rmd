...
imdb_basics_crew <- merge(imdb_basics_data, imdb_crew_data, by="tconst")
...
View(imdb_basics_crew)
#Merge the dataframe that was created above with the imdb_name_basics data
imdb_basics_crew_name <- imdb_basics_crew %>% left_join(imdb_name_basics, by= "nconst")
